...
abstract class AbstractProjectionPropertyEditor extends PropertyEditorSupport {
    ...
    public String[] getTags() {
        return SpectralSpatialisation.rows;
    }
    ...
    public void setValue(Object value) {
        for(int i=0;i<SpectralSpatialisation.rows.length;i++){
            if(SpectralSpatialisation.rows[i].equals((String)value)){
                selectedRow = SpectralSpatialisation.rows[i];
                break;
            }
        }
    }
